          ...
          <div className="justify-center flex flex-wrap">
            <div className="w-full lg:w-3/12 px-1"> {/* Adjust column width */}
              <div className="flex justify-center items-center">
                <div className="w-full lg:w-12/12 px-6"> {/* Adjust column width */}
                  ...
                  <Link to="/user/nouvelle_commande/guide_chirurgical">
            ...
            <div className="w-full lg:w-3/12 px-1"> {/* Adjust column width */}
              <div className="w-full lg:w-11/12 px-6"> {/* Adjust column width */}
                ...
                <Link to="/user/nouvelle_commande/aligneurs">
                  <div className="hover:-mt-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg ease-linear transition-all duration-150">
                    <img
                      alt="..."
                      className="align-middle border-none max-w-full h-auto rounded-lg" 
            ...
            <div className="w-full lg:w-3/12 px-1"> {/* Adjust column width */}
              <div className="w-full lg:w-11/12 px-6"> {/* Adjust column width */}
                ...
                <Link to="/user/nouvelle_commande/goutieres">
                  <div className="hover:-mt-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg ease-linear transition-all duration-150">
                    <img
                      alt="..."
                      className="align-middle border-none max-w-full h-auto rounded-lg" 
            ...
            <div className="w-full lg:w-3/12 px-1"> {/* Adjust column width */}
              <div className="w-full lg:w-11/12 px-6"> {/* Adjust column width */}
                ...
                <Link to="/user/nouvelle_commande/modeles_dentaires">
                  <div className="hover:-mt-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg ease-linear transition-all duration-150">
                    <img
                      alt="..."
                      className="align-middle border-none max-w-full h-auto rounded-lg" 
